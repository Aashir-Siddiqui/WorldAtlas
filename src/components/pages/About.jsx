      ...
      <BackgroundBeamsWithCollision>
        <div className="w-full bg-gradient-to-b from-slate-950 to-black/95 antialiased pt-20 pb-40 px-5 md:px-8 flex flex-col">
          <motion.div
            ...
            className="max-w-3xl sm:max-w-4xl md:max-w-7xl mx-auto text-center flex flex-col items-center justify-center gap-5 h-[35rem] sm:h-screen"
          >
          ...
          <div className="max-w-7xl mx-auto mt-16 md:mt-24 px-0 sm:px-8">
            <h2 className="text-neutral-300 text-2xl sm:text-4xl font-bold text-center">
              Global <span className='text-blue-500'>Organizations</span>
            </h2>
            <p className="text-neutral-300 text-base leading-6 md:text-lg mt-4 text-center">
